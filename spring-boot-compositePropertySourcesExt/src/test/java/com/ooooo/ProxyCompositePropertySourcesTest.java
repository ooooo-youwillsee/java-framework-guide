...
import com.ooooo.CompositePropertySourcesBeanPostProcessor.ProxyCompositePropertySources;
...
public class ProxyCompositePropertySourcesTest {
  ...
  private void removePropertySource(String name) {
    CompositePropertySources realCompositePropertySources = (CompositePropertySources) getField(compositePropertySources, ProxyCompositePropertySources.class,
                                                                                                "compositePropertySources");
    MutablePropertySources mutablePropertySources = (MutablePropertySources) getField(realCompositePropertySources, CompositePropertySources.class, "mutablePropertySources");
