...
import static com.ooooo.auth.crypt.SM4Utils.byteToHex;
import static com.ooooo.auth.crypt.SM4Utils.hexToByte;
...
public class SM4 {
  ...
  private byte[] padding(byte[] input, int mode) {
    ...
    if (mode == SM4_ENCRYPT) {
      ...
      String inputHex = byteToHex(input) + "80";
      StringBuilder sb = new StringBuilder(inputHex);
      for (int i = 0; i < p - 1; i++) {
        sb.append("00");
      }
      ret = hexToByte(sb.toString());
